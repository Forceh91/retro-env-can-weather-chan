...
export const thunderstormWarningEnded = `<?xml version='1.0' encoding='UTF-8' standalone='no'?>
<alert xmlns="urn:oasis:names:tc:emergency:cap:1.2">
    <identifier>urn:oid:2.50.0.1.124.1211373515.2023</identifier>
    <sender>cap-pac@canada.ca</sender>
    <sent>2023-08-05T22:44:46-00:00</sent>
    <status>Actual</status>
    <msgType>Update</msgType>
    ...
    <code>layer:SOREM:2.0</code>
    <note>Service Notice - February 2023: The Environment and Climate Change Canada (ECCC) CAP Service undergoes changes from time to time as the business of alerting evolves. For 2023, changes will include... 1) modifications, or even removal, of the Wireless Public Alerting Message (WPAM) layer due to the successful pilot of the UpdateX feature recently deployed in the Canadian Cell Broadcasting Environment, and 2) other minor improvements and corrections. For more information on these changes, you are invited to subscribe to the following mailing list: http://lists.cmc.ec.gc.ca/mailman/listinfo/dd_info | Notification de service - février 2023: Le service du PAC d’Environnement et Changement climatique Canada (ECCC) subit périodiquement des changements et ajouts à mesure que le système d’alerte évolue. Pour 2023, ces changements incluent... 1) des modifications, voire la suppression, de la couche du Service d’alertes sans fil au public (WPAM) en raison du succès du projet pilote de la fonctionnalité UpdateX récemment déployée dans l’environnement de diffusion sans fil canadien, et 2) d’autres améliorations et corrections mineures. Pour plus d’informations sur ces changements, vous êtes invités à vous inscrire à la liste de diffusion suivante: http://lists.cmc.ec.gc.ca/mailman/listinfo/dd_info</note>
    <references>urn:oid:2.49.0.1.124.1211373515.2023</references>
    <info>
        <language>en-CA</language>
        <category>Met</category>
        <event>thunderstorm</event>
        ...
        <description>something something no more storms
</description>
        <instruction>
Lightning kills and injures Canadians every year. Remember, when thunder roars, go indoors!
...
export const secondAlert = `<?xml version='1.0' encoding='UTF-8' standalone='no'?>
<alert xmlns="urn:oasis:names:tc:emergency:cap:1.2">
    <identifier>urn:oid:2.49.0.1.124.1573485680.2023</identifier>
    <sender>cap-pac@canada.ca</sender>
    <sent>2023-08-05T22:41:56-00:00</sent>
    <status>Actual</status>
    <msgType>Update</msgType>
    <source>Env. Can. - Can. Met. Ctr. – Montréal</source>
    <scope>Public</scope>
    ...
    <code>layer:SOREM:2.0</code>
    <note>Service Notice - February 2023: The Environment and Climate Change Canada (ECCC) CAP Service undergoes changes from time to time as the business of alerting evolves. For 2023, changes will include... 1) modifications, or even removal, of the Wireless Public Alerting Message (WPAM) layer due to the successful pilot of the UpdateX feature recently deployed in the Canadian Cell Broadcasting Environment, and 2) other minor improvements and corrections. For more information on these changes, you are invited to subscribe to the following mailing list: http://lists.cmc.ec.gc.ca/mailman/listinfo/dd_info | Notification de service - février 2023: Le service du PAC d’Environnement et Changement climatique Canada (ECCC) subit périodiquement des changements et ajouts à mesure que le système d’alerte évolue. Pour 2023, ces changements incluent... 1) des modifications, voire la suppression, de la couche du Service d’alertes sans fil au public (WPAM) en raison du succès du projet pilote de la fonctionnalité UpdateX récemment déployée dans l’environnement de diffusion sans fil canadien, et 2) d’autres améliorations et corrections mineures. Pour plus d’informations sur ces changements, vous êtes invités à vous inscrire à la liste de diffusion suivante: http://lists.cmc.ec.gc.ca/mailman/listinfo/dd_info</note>
    <references>cap-pac@canada.ca,urn:oid:2.49.0.1.124.2658201224.2023,2023-08-05T21:52:25-00:00 cap-pac@canada.ca,urn:oid:2.49.0.1.124.2078276054.2023,2023-08-05T21:56:14-00:00 cap-pac@canada.ca,urn:oid:2.49.0.1.124.4248465002.2023,2023-08-05T22:01:06-00:00</references>
    <info>
        <language>en-CA</language>
        <category>Met</category>
        <event>thunderstorm</event>
        ...
        <effective>2023-08-05T22:41:56-00:00</effective>
        <expires>2023-08-06T01:40:56-00:00</expires>
        <senderName>Environment Canada</senderName>
        <headline>severe thunderstorm warning in effect</headline>
        <description>
At 5:41 p.m. CDT (6:41 p.m. EDT), Environment Canada meteorologists are tracking a severe thunderstorm capable of producing strong wind gusts and up to nickel size hail.
...
Emergency Management Ontario recommends that you take cover immediately if threatening weather approaches.
        ...
        <parameter>
            <valueName>layer:EC-MSC-SMC:1.1:Parent_URI</valueName>
            <value>msc/alert/environment/hazard/alert-3.0-ascii/consolidated-xml-2.0/20230805224156160/ON_00_01_LAND/STW/215225336865160756202308050503_ON_00_01_LAND/actual/en_proper_complete_c-fr_not_present_u/NinJo</value>
        </parameter>
        <parameter>
            <valueName>layer:EC-MSC-SMC:1.1:CAP_count</valueName>
            <value>A:7846 M:43254 C:52365</value>
        </parameter>
        <parameter>
            <valueName>layer:EC-MSC-SMC:1.0:Alert_Location_Status</valueName>
            <value>active</value>
        ...
        <parameter>
            <valueName>layer:SOREM:1.0:Broadcast_Text</valueName>
            <value>At 6:41 p.m. Eastern Daylight Time Saturday, Environment Canada has issued a severe thunderstorm warning for far Northwestern Ontario. Extra care and attention should be exercised in and around the following localities: Big Trout Lake and Kasabonika. Environment Canada meteorologists are tracking a severe thunderstorm capable of producing strong wind gusts and up to nickel size hail. Take cover immediately if threatening weather approaches. Intense lightning is likely and tornados are possible with any thunderstorm that develops.</value>
        </parameter>
        <parameter>
            <valueName>layer:EC-MSC-SMC:1.1:Designation_Code</valueName>
            <value>ON_00_01_LAND</value>
        ...
        <parameter>
            <valueName>layer:SOREM:2.0:WirelessText</valueName>
            <value>At 6:41 p.m. Eastern Daylight Time Saturday, Environment Canada has updated a severe thunderstorm warning for this mobile coverage area. Take cover immediately if threatening weather approaches.</value>
        </parameter>
        <parameter>
            <valueName>layer:EC-MSC-SMC:1.1:Alert_Location_Status</valueName>
            <value>active</value>
    ...
    <info>
        ...
        <headline>alerte d'orages violents en vigueur</headline>
        <description>
À 17h41 HAC (18h41 HAE), les météorologues d’Environnement Canada surveillent un orage violent pouvant produire des rafales fortes et de la grêle pouvant atteindre la taille d’une pièce de cinq cents.
...
Gestion des situations d'urgence Ontario vous recommande de trouver un abri immédiatement si un phénomène météorologique menaçant est imminent.
        ...
        <parameter>
            <valueName>layer:SOREM:1.0:Broadcast_Text</valueName>
            <value>À 18h41 heure avancée de l'Est le samedi, Environnement Canada a émis une alerte d'orages violents pour l'extrême nord-ouest  de l'Ontario. Une attention et des précautions additionnelles devraient être exercées près et autour des localités suivantes: Big Trout Lake et Kasabonika. Les météorologues d’Environnement Canada surveillent un orage violent pouvant produire des rafales fortes et de la grêle pouvant atteindre la taille d’une pièce de cinq cents. Mettez-vous immédiatement à l'abri si un phénomène météorologique menaçant s'approche. De nombreux éclairs sont probables et il y a toujours un risque de tornade avec un orage.</value>
        </parameter>
        <parameter>
            <valueName>layer:EC-MSC-SMC:1.1:Designation_Code</valueName>
            <value>ON_00_01_LAND</value>
        ...
        <parameter>
            <valueName>layer:SOREM:2.0:WirelessText</valueName>
            <value>À 18h41 heure avancée de l'Est le samedi, Environnement Canada a mis à jour une alerte d'orages violents pour cette zone de couverture mobile. Mettez-vous immédiatement à l'abri si un phénomène météorologique menaçant s'approche.</value>
        </parameter>
        <parameter>
            <valueName>layer:EC-MSC-SMC:1.1:Alert_Location_Status</valueName>
            <value>active</value>
        ...
        <area>
            <areaDesc>Big Trout Lake - Kasabonika</areaDesc>
            <polygon>53.2172,-87.9958 53.3863,-89.3769 53.543,-90.5082 54.5994,-89.6775 55.4984,-88.8527 55.2628,-87.921 55.0075,-87.0122 54.1558,-87.4504 53.2172,-87.9958</polygon>
            <geocode>
                <valueName>layer:EC-MSC-SMC:1.0:CLC</valueName>
                <value>042420</value>
            </geocode>
...
<DigestMethod Algorithm="http://www.w3.org/2001/04/xmlenc#sha256"/>
<DigestValue>5Pc3dSY2yQCl+Dp/njYAz1O8lo84OQgF9BPpGmqZHkI=</DigestValue>
</Reference>
</SignedInfo>
<SignatureValue></SignatureValue>
<KeyInfo>
<X509Data>
<X509Certificate>MIIHQDCCBiigAwIBAgIQauIRkpOPcGViI+LoZHWDFzANBgkqhkiG9w0BAQsFADCB
ujELMAkGA1UEBhMCVVMxFjAUBgNVBAoTDUVudHJ1c3QsIEluYy4xKDAmBgNVBAsT
